...
<head>
    ...
    <style>  
        @page { margin: 10px 10px 10px 40px; } 
        body { font-family: DejaVu Sans, sans-serif; }/*/русские буквы шрифт */  
        .nubex {
	font-size: 9px;
	}    
    .nubex1 {
...
<body>
    <div class="nubex"> Первая строка </div>
    <div class="nubex1"> Вторая строка </div>
